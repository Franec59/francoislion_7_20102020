...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `fk_user_name` FOREIGN KEY (`user_name`) REFERENCES `users` (`username`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `comments` VALUES (34,'toto',130,'super !!!','2021-05-27 00:35:27');
...
-- Dump completed on 2021-06-18 17:32:54
