<template>
    <div class="container profil pt-3">
        ...
        <h2 class="mb-5 mt-3">Mon Compte</h2>
          
    <div class="row">
      <div class="col-2 col-lg-4"></div>

      <div class="col-8 col-lg-4 mt-3 contact"> 
          <h3 class="text-light mt-3">Supprimer mon profil</h3>
        ...
        <input class="btn btn-light btn-outline-success mt-3 mb-3" type="submit" value="Supprimer" v-on:click.prevent="deleteUser()">
